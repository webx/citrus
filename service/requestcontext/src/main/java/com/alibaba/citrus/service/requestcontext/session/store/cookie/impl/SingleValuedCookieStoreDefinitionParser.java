...
public class SingleValuedCookieStoreDefinitionParser extends
        AbstractSingleBeanDefinitionParser<SingleValuedCookieStoreImpl> implements ContributionAware {
    ...
    private void parseEncoders(Element element, ParserContext parserContext, BeanDefinitionBuilder builder) {
        ...
        builder.addPropertyValue("valueEncoders", encoders);
    }
}
